...
local Window = OrionLib:MakeWindow({Name = "VOLTS HUB", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "VOLTS HUB"})

OrionLib:MakeNotification({
	Name = "VOLTS HUB",
	Content = "Choose Teams Bro?",
	Image = "rbxassetid://119348241367191",
	Time = 7
})
...
local W = Window:MakeTab({
    Name = "Welcome",
    Icon = "rbxassetid://119348241367191",
    PremiumOnly = false
})
